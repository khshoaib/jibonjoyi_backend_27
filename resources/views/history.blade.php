...
<head>
    ...
    <!-- Newstyle CSS -->
    <link rel="stylesheet" href="{{url('frontend/assets/css/history.css')}}">
...
<body>
    ...
    <head>
        ...
        <header class="header">
            <div class="logo">
                <a href="index.html"> <img src="{{url('img/jibonjoyi.png')}}" alt="Logo" class="logo"></a>
            </div>
    ...
    <body>
        ...
        <div class="container content" id="philosophy" class="container content" id="history" style="background-color: #f0f5f8">
            ...
            <div class="card-container">
                <div class="card">
                    <img src="assets/img/U2.png" alt="Historical Image">
                    <div class="card-content">
                        <h3 class="card-title">মৈথেলিক সমরোহতের ইতিহাস</h3>
                        <p class="card-meta">
                            <span>
                ...
                <div class="card">
                    <img src="assets/img/U1.png" alt="Historical Image">
                    <div class="card-content">
                                            ...
                                            <div class="blog-style2">
                                                ...
                                                <div class="blog-content">
                                                    ...
                                                    <div class="blog-meta">
                                                        ...
                                                        <a href="{{ route('history') }}" class="cats_item"
        ...
        <script>
            ...
            document.addEventListener("DOMContentLoaded", function () {
                const defaultButton = document.querySelector(".buttons button:nth-child(1)"); // Adjust based on button order
                if (defaultButton) {
