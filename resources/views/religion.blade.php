...
<head>
    ...
    <!-- Newstyle CSS -->
    <link rel="stylesheet" href="{{url('frontend/assets/css/religion.css')}}">
    ...
    <body>
        ...
        <script>
            ...
            document.addEventListener("DOMContentLoaded", function () {
                const defaultButton = document.querySelector(".buttons button:nth-child(3)"); // Adjust based on button order
                if (defaultButton) {
