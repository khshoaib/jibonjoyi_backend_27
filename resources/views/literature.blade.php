...
<head>
    ...
    <!-- Newstyle CSS -->
    <link rel="stylesheet" href="{{url('frontend/assets/css/literature.css')}}">
...
<body>
    ...
    <head>
        ...
        <header class="header">
            <div class="logo">
                <a href="index.html"> <img src="img/jibonjoyi.png" alt="Logo" class="logo"></a>
            </div>
    ...
    <body>
        ...
        <div class="container content" id="literature" class="container content" id="history" style="background-color: #f0f5f8">
            <div class="headerr" style="background-color: #f0f5f8;">
                <h1>সাহিত্য</h1>
                <pp>আজাকের বাণী</pp>
                <p class="quote">মানুষের পুরো জীবনটা হচ্ছে একটা সরল অংক, যতই দিন যাচ্ছে ততই আমরা তার সমাধানের দিকে
                                            ...
                                            <div class="blog-style2">
                                                ...
                                                <div class="blog-content">
                                                    ...
                                                    <div class="blog-meta">
                                                        ...
                                                        <a href="{{ route('literature') }}" class="cats_item"
        ...
        <script>
            ...
            document.addEventListener("DOMContentLoaded", function () {
                const defaultButton = document.querySelector(".buttons button:nth-child(9)"); // Adjust based on button order
                if (defaultButton) {
