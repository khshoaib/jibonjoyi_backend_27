...
<head>
    ...
    <!-- Newstyle CSS -->
    <link rel="stylesheet" href="{{url('frontend/assets/css/world.css">
    ...
    <body>
                                    ...
                                    <div class="">
                                        ...
                                        <div style="width: 100%;">
                                            ...
                                            <div class="blog-style1">
                                                <div class="blog-container">
                                                    <div class="blog-img">
                                                        <img src="{{url('frontend/assets/img/9.png')}}" alt="blog image">
                                                    </div>
                                                    <div class="blog-content">
                                                        <h3 class="box-title-24">
                                                            <a class="hover-line" href="{{ route('jibonjoyi_details') }}"
                                            ...
                                            <div class="blog-style2">
                                                ...
                                                <div class="blog-content">
                                                    ...
                                                    <div class="blog-meta">
                                                        ...
                                                        <a href="{{ route('world') }}" class="cats_item"
        ...
        <script>
            ...
            document.addEventListener("DOMContentLoaded", function () {
                const defaultButton = document.querySelector(".buttons button:nth-child(7)"); // Adjust based on button order
                if (defaultButton) {
