...
<head>
    ...
    <!-- Newstyle CSS -->
    <link rel="stylesheet" href="{{url('frontend/assets/css/economy.css')}}">
    ...
    <body>
                                            ...
                                            <div class="blog-style2">
                                                ...
                                                <div class="blog-content">
                                                    ...
                                                    <div class="blog-meta">
                                                        ...
                                                        <a href="{{ route('economy') }}" class="cats_item"
        ...
        <script>
            ...
            document.addEventListener("DOMContentLoaded", function () {
                const defaultButton = document.querySelector(".buttons button:nth-child(8)"); // Adjust based on button order
                if (defaultButton) {
