...
<body>
    ...
    <head>
        ...
        <header class="header">
            <div class="logo">
                <img src="assets/img/jibonjoyi.png" alt="Logo">
            </div>

            <div class="buttons">
                <button class="red" onclick="markButton(this); showContent('history')">ইতিহাস</button>
                <button class="green" onclick="markButton(this); showContent('philosophy')">দর্শন</button>
                <button class="green" onclick="markButton(this); showContent('religion')">ধর্ম</button>
                <button class="blue" onclick="markButton(this); showContent('sports')">খেলাধুলা</button>
                <button class="gold" onclick="markButton(this); showContent('travel')">ভ্রমণ</button>
                <button class="green" onclick="markButton(this); showContent('liberation')">মুক্তিযুদ্ধ</button>
                <button onclick="markButton(this); showContent('world')">বিশ্ব</button>
                <button class="red" onclick="markButton(this); showContent('economy')">অর্থনীতি</button>
                <button onclick="markButton(this); showContent('politics')">রাজনীতি</button>
                <button class="gold" onclick="markButton(this); showContent('science')">বিজ্ঞান</button>
            </div>
    ...
    <body>
        <div class="container" id="history" style="background-color: #f0f5f8">
            <div style="background-color: #f0f5f8;">
                ...
                <div class="card-container">
                    <!-- First Card -->
                    <div class="card">
                        <img src="assets/img/U1.png" alt="Historical Image" style="border-radius: 10px;">
                        <div class="card-content">
                            <h3 class="card-title">গিয়াসউদ্দিন আজম শাহ: বাংলা সানাতনাতের সাহিত্যচরিতানুরাগী এক
                                আদর্শচনশীল শাসক</h3>
                            <p class="card-meta">
                                <span>
                                    <img src="assets/img/w1.png" alt="Author"
                    ...
                    <!-- Second Card -->
                    <div class="card">
                        <img src="assets/img/U2.png" alt="Historical Image" style="border-radius: 10px;">
                        <div class="card-content">
        ...
        <div style="margin: 0 auto; width: 80%; max-width: 1200px; min-width: 600px; box-sizing: border-box;">
            <div>
                <div class="space-bottom" style="text-align: center;">
                    <a href="https://themeforest.net/user/themeholy/portfolio">
                        <img class="w-80 light-img" src="assets/img/ad1.png" alt="ads">
                    </a>
                </div>
                <section class="space">
                    <div class="container">
                                ...
                                <div class="row gy-4">
                                    <div class="col-lg-4 col-sm-6">
                                        <div class="blog-style1">
                                            <div class="blog-img">
                                                <img src="assets/img/1.png" alt="blog image">
                                            </div>
                                            <h3 class="box-title-20"><a class="hover-line" href="2nd.html">সিন্ধু
                                                    সভ্যতার
                                    ...
                                    <div class="col-lg-4 col-sm-6">
                                        <div class="blog-style1">
                                            <div class="blog-img">
                                                <img src="assets/img/2.png" alt="blog image">
                                            </div>
                                            <h3 class="box-title-20"><a class="hover-line" href="2nd.html">যেভাবে
                                                    শুরু
                                    ...
                                    <div class="col-lg-4 col-sm-6">
                                        <div class="blog-style1">
                                            <div class="blog-img">
                                                <img src="assets/img/3.png" alt="blog image">
                                            </div>
                                            <h3 class="box-title-20"><a class="hover-line" href="2nd.html">অটোমান
                                                    সাম্রাজ্য
                                                    ভাঙন</a></h3>
                                            <p class="card-meta">
                                                <span
                                    ...
                                    <div class="col-lg-4 col-sm-6">
                                        <div class="blog-style1">
                                            <div class="blog-img">
                                                <img src="assets/img/4.png" alt="blog image">
                                            </div>
                                            <h3 class="box-title-20"><a class="hover-line" href="2nd.html">মোগল
                                                    সাম্রাজ্যের
                                                    পতন</a></h3>
                                            <p class="card-meta">
                                                <span
                                    ...
                                    <div class="col-lg-4 col-sm-6">
                                        <div class="blog-style1">
                                            <div class="blog-img">
                                                <img src="assets/img/5.png" alt="blog image">
                                            </div>
                                            <h3 class="box-title-20"><a class="hover-line"
                                                    href="2nd.html">প্রাচীন পারস্য
                                                    সভ্যতা</a></h3>
                                            <p class="card-meta">
                                                <span
                                                    style="font-size: 12px; font-weight: lighter;margin-left: 0%;margin-right: -3%;">সুস্মিতা
                                    ...
                                    <div class="col-lg-4 col-sm-6">
                                        <div class="blog-style1">
                                            <div class="blog-img">
                                                <img src="assets/img/6.png" alt="blog image">
                                            </div>
                                            <h3 class="box-title-20"><a class="hover-line"
                                                    href="2nd.html">প্রাচীন মিশরের
                                                    সমাধি</a></h3>
                                            <p class="card-meta">
                                                <span
                                                    style="font-size: 12px; font-weight: lighter;margin-left: 0%;margin-right: -3%;">সুস্মিতা
                                ...
                                <div class="mt-30">
                                    ...
                                    সকল পোস্ট </h2>
                                                <div class="blog-container">
                                                    <div class="blog-img">
                                                        <img src="assets/img/7.png" alt="blog image">
                                                    </div>
                                                    <div class="blog-content">
                                                        <h3 class="box-title-24">
                                                            <a class="hover-line" href="2nd.html"
                                            ...
                                            <div class="blog-style1">
                                                <div class="blog-container">
                                                    <div class="blog-img">
                                                        <img src="assets/img/8.png" alt="blog image">
                                                    </div>
                                                    <div class="blog-content">
                                                        <h3 class="box-title-24">
                                                            <a class="hover-line" href="2nd.html"
                                            ...
                                            <div class="blog-style1">
                                                <div class="blog-container">
                                                    <div class="blog-img">
                                                        <img src="assets/img/10.png" alt="blog image">
                                                    </div>
                                                    <div class="blog-content">
                                                        <h3 class="box-title-24">
                                                            <a class="hover-line" href="2nd.html"
                                            ...
                                            <div class="blog-style1">
                                                <div class="blog-container">
                                                    <div class="blog-img">
                                                        <img src="assets/img/11.png" alt="blog image">
                                                    </div>
                                                    <div class="blog-content">
                                                        <h3 class="box-title-24">
                                                            <a class="hover-line" href="2nd.html"
                                            ...
                                            <div class="blog-style1">
                                                <div class="blog-container">
                                                    <div class="blog-img">
                                                        <img src="assets/img/12.png" alt="blog image">
                                                    </div>
                                                    <div class="blog-content">
                                                        <h3 class="box-title-24">
                                                            <a class="hover-line" href="2nd.html"
                                    ...
                                    <div class="row gy-4">
                                        ...
                                        <div class="col-xl-12 col-md-6 border-blog">
                                            <div class="blog-style2">
                                                <div>
                                                    <img style="height: 130px;width: 150px;border-radius: 10px;"
                                                        src="assets/img/s2.png" alt="blog image">
                                                </div>
                                                <div class="blog-content">
                                        ...
                                        <div class="col-xl-12 col-md-6 border-blog">
                                            <div class="blog-style2">
                                                <div>
                                                    <img style="height: 130px;width: 150px;border-radius: 10px;"
                                                        src="assets/img/s3.png" alt="blog image">
                                                </div>
                                                <div class="blog-content">
                                        ...
                                        <div class="col-xl-12 col-md-6 border-blog">
                                            <div class="blog-style2">
                                                <div>
                                                    <img style="height: 130px;width: 150px;border-radius: 10px;"
                                                        src="assets/img/s4.png" alt="blog image">
                                                </div>
                                                <div class="blog-content">
                                        ...
                                        <div class="col-xl-12 col-md-6 border-blog">
                                            <div class="blog-style2">
                                                <div>
                                                    <img style="height: 130px;width: 150px;border-radius: 10px;"
                                                        src="assets/img/s5.png" alt="blog image">
                                                </div>
                                                <div class="blog-content">
                                        ...
                                        <div class="col-xl-12 col-md-6 border-blog">
                                            <div class="blog-style2">
                                                <div>
                                                    <img style="height: 130px;width: 150px;border-radius: 10px;"
                                                        src="assets/img/s6.png" alt="blog image">
                                                </div>
                                                <div class="blog-content">
                                            ...
                                            <div class="">
                                                <a href="https://themeforest.net/user/themeholy/portfolio">
                                                    <img style="width: 450px;" class="w-80 light-img"
                                                        src="assets/img/ad2.png" alt="ads">
                                                </a>
                                            </div>
                                        </div>
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function () {
                ...
                // Hide all content divs except the default one
