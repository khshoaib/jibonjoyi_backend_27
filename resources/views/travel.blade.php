...
<head>
    ...
    <!-- Newstyle CSS -->
    <link rel="stylesheet" href="{{url('frontend/assets/css/travel.css')}}">
    ...
    <body>
            ...
            <div>
                <!-- <div class="space-bottom" style="text-align: center; margin-top: 120px;">
                    <a href="https://www.ridgebenit.com">
                        <img class="w-80 light-img" src="{{url('frontend/assets/img/ad2.png')}}" alt="ads">
                    </a>
                </div> -->
                                            ...
                                            <div class="blog-style2">
                                                ...
                                                <div class="blog-content">
                                                    ...
                                                    <div class="blog-meta">
                                                        ...
                                                        <a href="{{ route('travel') }}" class="cats_item"
        ...
        <script>
            ...
            document.addEventListener("DOMContentLoaded", function () {
                const defaultButton = document.querySelector(".buttons button:nth-child(5)"); // Adjust based on button order
                if (defaultButton) {
