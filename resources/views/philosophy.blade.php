...
<head>
    ...
    <!-- Newstyle CSS -->
    <link rel="stylesheet" href="{{url('frontend/assets/css/philosophy.css')}}">
...
<body>
    ...
    <body>
        ...
        <div class="container content" id="philosophy">
            <div class="headerr">
                <h1>দর্শন</h1>
                <pp>আজাকের বাণী</pp>
                <p class="quote">মানুষের পুরো জীবনটা হচ্ছে একটা সরল অংক, যতই দিন যাচ্ছে ততই আমরা তার সমাধানের দিকে
        ...
        <div class="container content" id="religion">
            <div class="headerr">
                <h1>ধর্ম</h1>
                <pp>আজাকের বাণী</pp>
                <p class="quote">মানুষের পুরো জীবনটা হচ্ছে একটা সরল অংক, যতই দিন যাচ্ছে ততই আমরা তার সমাধানের দিকে
        ...
        <div class="container content" id="sports">
            <div class="headerr">
                <h1>খেলাধুলা</h1>
                <pp>আজাকের বাণী</pp>
                <p class="quote">মানুষের পুরো জীবনটা হচ্ছে একটা সরল অংক, যতই দিন যাচ্ছে ততই আমরা তার সমাধানের দিকে
        ...
        <div class="container content" id="travel">
            <div class="headerr">
                <h1>ভ্রমণ</h1>
                <pp>আজাকের বাণী</pp>
                <p class="quote">মানুষের পুরো জীবনটা হচ্ছে একটা সরল অংক, যতই দিন যাচ্ছে ততই আমরা তার সমাধানের দিকে
        ...
        <div class="container content" id="liberation">
            <div class="headerr">
                <h1>মুক্তিযুদ্ধ</h1>
                <pp>আজাকের বাণী</pp>
                <p class="quote">মানুষের পুরো জীবনটা হচ্ছে একটা সরল অংক, যতই দিন যাচ্ছে ততই আমরা তার সমাধানের দিকে
        ...
        <div class="container content" id="world">
            <div class="headerr">
                <h1>বিশ্ব</h1>
                <pp>আজাকের বাণী</pp>
                <p class="quote">মানুষের পুরো জীবনটা হচ্ছে একটা সরল অংক, যতই দিন যাচ্ছে ততই আমরা তার সমাধানের দিকে
        ...
        <div class="container content" id="economy">
            <div class="headerr">
                <h1>অর্থনীতি</h1>
                <pp>আজাকের বাণী</pp>
                <p class="quote">মানুষের পুরো জীবনটা হচ্ছে একটা সরল অংক, যতই দিন যাচ্ছে ততই আমরা তার সমাধানের দিকে
        ...
        <div class="container content" id="politics">
            <div class="headerr">
                <h1>রাজনীতি</h1>
                <pp>আজাকের বাণী</pp>
                <p class="quote">মানুষের পুরো জীবনটা হচ্ছে একটা সরল অংক, যতই দিন যাচ্ছে ততই আমরা তার সমাধানের দিকে
        ...
        <div class="container content" id="science">
            <div class="headerr">
                <h1>বিজ্ঞান</h1>
                <pp>আজাকের বাণী</pp>
                <p class="quote">মানুষের পুরো জীবনটা হচ্ছে একটা সরল অংক, যতই দিন যাচ্ছে ততই আমরা তার সমাধানের দিকে
                                        ...
                                        <div style="width: 100%;">
                                            <div class="blog-style1">
                                                ...
                                                <div class="blog-container">
                                                    <div class="blog-img">
                                                        <img src="{{url('frontend/assets/img/7.png')}}"
                                                            alt="blog image">
                                                    </div>
                                                    <div class="blog-content">
                                                        <h3 class="box-title-24">
                                                            <a class="hover-line"
                                                                href="{{ route('jibonjoyi_details') }}"
                                            ...
                                            <div class="blog-style1">
                                                <div class="blog-container">
                                                    <div class="blog-img">
                                                        <img src="{{url('frontend/assets/img/8.png')}}"
                                                            alt="blog image">
                                                    </div>
                                                    <div class="blog-content">
                                                        <h3 class="box-title-24">
                                            ...
                                            <div class="blog-style1">
                                                <div class="blog-container">
                                                    <div class="blog-img">
                                                        <img src="{{url('frontend/assets/img/9.png')}}"
                                                            alt="blog image">
                                                    </div>
                                                    <div class="blog-content">
                                                        <h3 class="box-title-24">
                                            ...
                                            <div class="blog-style1">
                                                <div class="blog-container">
                                                    <div class="blog-img">
                                                        <img src="{{url('frontend/assets/img/10.png')}}"
                                                            alt="blog image">
                                                    </div>
                                                    <div class="blog-content">
                                                        <h3 class="box-title-24">
                                            ...
                                            <div class="blog-style1">
                                                <div class="blog-container">
                                                    <div class="blog-img">
                                                        <img src="{{url('frontend/assets/img/11.png')}}"
                                                            alt="blog image">
                                                    </div>
                                                    <div class="blog-content">
                                                        <h3 class="box-title-24">
                                            ...
                                            <div class="blog-style1">
                                                <div class="blog-container">
                                                    <div class="blog-img">
                                                        <img src="{{url('frontend/assets/img/12.png')}}"
                                                            alt="blog image">
                                                    </div>
                                                    <div class="blog-content">
                                                        <h3 class="box-title-24">
        ...
        <script>
            ...
            document.addEventListener("DOMContentLoaded", function () {
                const defaultButton = document.querySelector(".buttons button:nth-child(2)"); // Adjust based on button order
                if (defaultButton) {
